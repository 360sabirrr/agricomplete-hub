...
const supplementalTranslations = {
 ...
 mandi_kicker: "Official mandi intelligence",
 mandi_heading: "Live Mandi Price Intelligence",
 mandi_subtitle: "Compare official commodity rates across states, districts, and markets using secure server-side Data.gov.in integration.",
 mandi_state: "State",
 mandi_commodity: "Commodity",
 mandi_district_optional: "District optional",
 mandi_market_optional: "Market optional",
 mandi_limit: "Limit",
 mandi_search_prices: "Search Prices",
 mandi_district_placeholder: "e.g. Nashik",
 mandi_market_placeholder: "e.g. Lasalgaon",
 mandi_chart_kicker: "Market intelligence",
 mandi_chart_title: "Mandi Price Comparison",
 mandi_chart_subtitle: "Official min, modal, and max prices in rupees per quintal",
 mandi_avg_modal: "Avg modal",
 mandi_top_market: "Top market",
 mandi_price_spread: "Price spread",
 mandi_chart_insight_empty: "Search mandi prices to compare markets.",
 mandi_records_kicker: "Live records",
 mandi_records_title: "Official Mandi Price List",
 mandi_records_subtitle: "Cards and table below update from the same Data.gov.in search.",
 mandi_table_date: "Date",
 mandi_table_district: "District",
 mandi_table_market: "Market",
 mandi_variety: "Variety",
 mandi_min_price: "Min Price",
 mandi_modal_price: "Modal Price",
 mandi_max_price: "Max Price",
 mandi_table_initial: "Search mandi prices to load official records.",
 mandi_no_records: "No records found",
 mandi_try_broader: "Try a broader district or market filter.",
 mandi_location_unavailable: "Location not available",
 mandi_not_specified: "Not specified",
 mandi_loading_prices: "Loading official mandi prices...",
 mandi_loading: "Loading...",
 mandi_no_records_long: "No records found. Try changing commodity, district, or market.",
 mandi_load_error: "Could not load official mandi prices.",
 mandi_selected_records: "official records loaded for",
 mandi_modal_line_note: "Modal line highlights the most realistic trading price."
 },
 hi: {
 ...
 mandi_kicker: "आधिकारिक मंडी इंटेलिजेंस",
 mandi_heading: "लाइव मंडी भाव इंटेलिजेंस",
 mandi_subtitle: "सुरक्षित सर्वर-साइड Data.gov.in इंटीग्रेशन से राज्य, जिला और मंडी के आधिकारिक कमोडिटी भाव तुलना करें।",
 mandi_state: "राज्य",
 mandi_commodity: "कमोडिटी",
 mandi_district_optional: "जिला वैकल्पिक",
 mandi_market_optional: "मंडी वैकल्पिक",
 mandi_limit: "सीमा",
 mandi_search_prices: "भाव खोजें",
 mandi_district_placeholder: "जैसे नासिक",
 mandi_market_placeholder: "जैसे लासलगांव",
 mandi_chart_kicker: "बाजार इंटेलिजेंस",
 mandi_chart_title: "मंडी भाव तुलना",
 mandi_chart_subtitle: "रुपये प्रति क्विंटल में आधिकारिक न्यूनतम, मॉडल और अधिकतम भाव",
 mandi_avg_modal: "औसत मॉडल",
 mandi_top_market: "शीर्ष मंडी",
 mandi_price_spread: "भाव अंतर",
 mandi_chart_insight_empty: "मंडियों की तुलना के लिए भाव खोजें।",
 mandi_records_kicker: "लाइव रिकॉर्ड",
 mandi_records_title: "आधिकारिक मंडी भाव सूची",
 mandi_records_subtitle: "नीचे कार्ड और टेबल इसी Data.gov.in खोज से अपडेट होते हैं।",
 mandi_table_date: "तारीख",
 mandi_table_district: "जिला",
 mandi_table_market: "मंडी",
 mandi_variety: "किस्म",
 mandi_min_price: "न्यूनतम भाव",
 mandi_modal_price: "मॉडल भाव",
 mandi_max_price: "अधिकतम भाव",
 mandi_table_initial: "आधिकारिक रिकॉर्ड लोड करने के लिए मंडी भाव खोजें।",
 mandi_no_records: "कोई रिकॉर्ड नहीं मिला",
 mandi_try_broader: "जिला या मंडी फिल्टर को थोड़ा व्यापक करें।",
 mandi_location_unavailable: "स्थान उपलब्ध नहीं",
 mandi_not_specified: "निर्दिष्ट नहीं",
 mandi_loading_prices: "आधिकारिक मंडी भाव लोड हो रहे हैं...",
 mandi_loading: "लोड हो रहा है...",
 mandi_no_records_long: "कोई रिकॉर्ड नहीं मिला। कमोडिटी, जिला या मंडी बदलकर देखें।",
 mandi_load_error: "आधिकारिक मंडी भाव लोड नहीं हो सके।",
 mandi_selected_records: "आधिकारिक रिकॉर्ड लोड हुए",
 mandi_modal_line_note: "मॉडल लाइन सबसे व्यावहारिक व्यापार भाव दिखाती है।"
 },
 mr: {
 ...
 mandi_kicker: "अधिकृत बाजारभाव इंटेलिजन्स",
 mandi_heading: "लाईव्ह बाजारभाव इंटेलिजन्स",
 mandi_subtitle: "सुरक्षित सर्व्हर-साइड Data.gov.in इंटिग्रेशनने राज्य, जिल्हा आणि बाजारातील अधिकृत कमोडिटी दरांची तुलना करा.",
 mandi_state: "राज्य",
 mandi_commodity: "कमोडिटी",
 mandi_district_optional: "जिल्हा वैकल्पिक",
 mandi_market_optional: "बाजार वैकल्पिक",
 mandi_limit: "मर्यादा",
 mandi_search_prices: "भाव शोधा",
 mandi_district_placeholder: "उदा. नाशिक",
 mandi_market_placeholder: "उदा. लासलगाव",
 mandi_chart_kicker: "बाजार इंटेलिजन्स",
 mandi_chart_title: "बाजारभाव तुलना",
 mandi_chart_subtitle: "रुपये प्रति क्विंटलमधील अधिकृत किमान, मॉडल आणि कमाल भाव",
 mandi_avg_modal: "सरासरी मॉडल",
 mandi_top_market: "शीर्ष बाजार",
 mandi_price_spread: "भाव फरक",
 mandi_chart_insight_empty: "बाजारांची तुलना करण्यासाठी भाव शोधा.",
 mandi_records_kicker: "लाईव्ह नोंदी",
 mandi_records_title: "अधिकृत बाजारभाव यादी",
 mandi_records_subtitle: "खालील कार्ड आणि टेबल त्याच Data.gov.in शोधातून अपडेट होतात.",
 mandi_table_date: "तारीख",
 mandi_table_district: "जिल्हा",
 mandi_table_market: "बाजार",
 mandi_variety: "वाण",
 mandi_min_price: "किमान भाव",
 mandi_modal_price: "मॉडल भाव",
 mandi_max_price: "कमाल भाव",
 mandi_table_initial: "अधिकृत नोंदी लोड करण्यासाठी बाजारभाव शोधा.",
 mandi_no_records: "नोंदी आढळल्या नाहीत",
 mandi_try_broader: "जिल्हा किंवा बाजार फिल्टर व्यापक करा.",
 mandi_location_unavailable: "स्थान उपलब्ध नाही",
 mandi_not_specified: "निर्दिष्ट नाही",
 mandi_loading_prices: "अधिकृत बाजारभाव लोड होत आहेत...",
 mandi_loading: "लोड होत आहे...",
 mandi_no_records_long: "नोंदी आढळल्या नाहीत. कमोडिटी, जिल्हा किंवा बाजार बदला.",
 mandi_load_error: "अधिकृत बाजारभाव लोड होऊ शकले नाहीत.",
 mandi_selected_records: "अधिकृत नोंदी लोड झाल्या",
 mandi_modal_line_note: "मॉडल लाइन सर्वात व्यावहारिक व्यापार भाव दाखवते."
 },
 pa: {
 mandi_kicker: "ਅਧਿਕਾਰਤ ਮੰਡੀ ਜਾਣਕਾਰੀ",
 mandi_heading: "ਲਾਈਵ ਮੰਡੀ ਕੀਮਤ ਇੰਟੈਲੀਜੈਂਸ",
 mandi_subtitle: "ਸੁਰੱਖਿਅਤ ਸਰਵਰ-ਸਾਈਡ Data.gov.in ਇੰਟੀਗ੍ਰੇਸ਼ਨ ਨਾਲ ਰਾਜਾਂ, ਜ਼ਿਲ੍ਹਿਆਂ ਅਤੇ ਮੰਡੀਆਂ ਦੇ ਅਧਿਕਾਰਤ ਕਮੋਡਿਟੀ ਰੇਟਾਂ ਦੀ ਤੁਲਨਾ ਕਰੋ।",
 mandi_state: "ਰਾਜ",
 mandi_commodity: "ਕਮੋਡਿਟੀ",
 mandi_district_optional: "ਜ਼ਿਲ੍ਹਾ ਵਿਕਲਪਿਕ",
 mandi_market_optional: "ਮੰਡੀ ਵਿਕਲਪਿਕ",
 mandi_limit: "ਸੀਮਾ",
 mandi_search_prices: "ਕੀਮਤਾਂ ਖੋਜੋ",
 mandi_district_placeholder: "ਜਿਵੇਂ ਨਾਸਿਕ",
 mandi_market_placeholder: "ਜਿਵੇਂ ਲਾਸਲਗਾਂਵ",
 mandi_chart_kicker: "ਮਾਰਕੀਟ ਇੰਟੈਲੀਜੈਂਸ",
 mandi_chart_title: "ਮੰਡੀ ਕੀਮਤ ਤੁਲਨਾ",
 mandi_chart_subtitle: "ਰੁਪਏ ਪ੍ਰਤੀ ਕਵਿੰਟਲ ਵਿੱਚ ਅਧਿਕਾਰਤ ਘੱਟੋ-ਘੱਟ, ਮਾਡਲ ਅਤੇ ਵੱਧ ਤੋਂ ਵੱਧ ਕੀਮਤਾਂ",
 mandi_avg_modal: "ਔਸਤ ਮਾਡਲ",
 mandi_top_market: "ਟੌਪ ਮੰਡੀ",
 mandi_price_spread: "ਕੀਮਤ ਫਰਕ",
 mandi_chart_insight_empty: "ਮੰਡੀਆਂ ਦੀ ਤੁਲਨਾ ਲਈ ਕੀਮਤਾਂ ਖੋਜੋ।",
 mandi_records_kicker: "ਲਾਈਵ ਰਿਕਾਰਡ",
 mandi_records_title: "ਅਧਿਕਾਰਤ ਮੰਡੀ ਕੀਮਤ ਸੂਚੀ",
 mandi_records_subtitle: "ਹੇਠਾਂ ਕਾਰਡ ਅਤੇ ਟੇਬਲ ਉਸੇ Data.gov.in ਖੋਜ ਤੋਂ ਅਪਡੇਟ ਹੁੰਦੇ ਹਨ।",
 mandi_table_date: "ਤਾਰੀਖ",
 mandi_table_district: "ਜ਼ਿਲ੍ਹਾ",
 mandi_table_market: "ਮੰਡੀ",
 mandi_variety: "ਕਿਸਮ",
 mandi_min_price: "ਘੱਟੋ-ਘੱਟ ਕੀਮਤ",
 mandi_modal_price: "ਮਾਡਲ ਕੀਮਤ",
 mandi_max_price: "ਵੱਧ ਤੋਂ ਵੱਧ ਕੀਮਤ",
 mandi_table_initial: "ਅਧਿਕਾਰਤ ਰਿਕਾਰਡ ਲੋਡ ਕਰਨ ਲਈ ਮੰਡੀ ਕੀਮਤਾਂ ਖੋਜੋ।",
 mandi_no_records: "ਕੋਈ ਰਿਕਾਰਡ ਨਹੀਂ ਮਿਲਿਆ",
 mandi_try_broader: "ਜ਼ਿਲ੍ਹਾ ਜਾਂ ਮੰਡੀ ਫਿਲਟਰ ਵੱਡਾ ਕਰੋ।",
 mandi_location_unavailable: "ਸਥਾਨ ਉਪਲਬਧ ਨਹੀਂ",
 mandi_not_specified: "ਨਿਰਧਾਰਤ ਨਹੀਂ",
 mandi_loading_prices: "ਅਧਿਕਾਰਤ ਮੰਡੀ ਕੀਮਤਾਂ ਲੋਡ ਹੋ ਰਹੀਆਂ ਹਨ...",
 mandi_loading: "ਲੋਡ ਹੋ ਰਿਹਾ ਹੈ...",
 mandi_no_records_long: "ਕੋਈ ਰਿਕਾਰਡ ਨਹੀਂ ਮਿਲਿਆ। ਕਮੋਡਿਟੀ, ਜ਼ਿਲ੍ਹਾ ਜਾਂ ਮੰਡੀ ਬਦਲੋ।",
 mandi_load_error: "ਅਧਿਕਾਰਤ ਮੰਡੀ ਕੀਮਤਾਂ ਲੋਡ ਨਹੀਂ ਹੋ ਸਕੀਆਂ।",
 mandi_selected_records: "ਅਧਿਕਾਰਤ ਰਿਕਾਰਡ ਲੋਡ ਹੋਏ",
 mandi_modal_line_note: "ਮਾਡਲ ਲਾਈਨ ਸਭ ਤੋਂ ਅਸਲੀ ਵਪਾਰ ਕੀਮਤ ਦਿਖਾਉਂਦੀ ਹੈ।"
 },
 ta: {
 mandi_kicker: "அதிகாரப்பூர்வ சந்தை நுண்ணறிவு",
 mandi_heading: "நேரடி சந்தை விலை நுண்ணறிவு",
 mandi_subtitle: "பாதுகாப்பான சர்வர்-சைடு Data.gov.in இணைப்பின் மூலம் மாநிலம், மாவட்டம், சந்தை வாரியான அதிகாரப்பூர்வ பொருள் விலைகளை ஒப்பிடுங்கள்.",
 mandi_state: "மாநிலம்",
 mandi_commodity: "பொருள்",
 mandi_district_optional: "மாவட்டம் விருப்பம்",
 mandi_market_optional: "சந்தை விருப்பம்",
 mandi_limit: "வரம்பு",
 mandi_search_prices: "விலைகளை தேடுங்கள்",
 mandi_district_placeholder: "எ.கா. நாசிக்",
 mandi_market_placeholder: "எ.கா. லாசல்கான்",
 mandi_chart_kicker: "சந்தை நுண்ணறிவு",
 mandi_chart_title: "சந்தை விலை ஒப்பீடு",
 mandi_chart_subtitle: "குவிண்டாலுக்கு ரூபாயில் அதிகாரப்பூர்வ குறைந்த, மாடல் மற்றும் அதிக விலைகள்",
 mandi_avg_modal: "சராசரி மாடல்",
 mandi_top_market: "சிறந்த சந்தை",
 mandi_price_spread: "விலை வித்தியாசம்",
 mandi_chart_insight_empty: "சந்தைகளை ஒப்பிட விலைகளை தேடுங்கள்.",
 mandi_records_kicker: "நேரடி பதிவுகள்",
 mandi_records_title: "அதிகாரப்பூர்வ சந்தை விலை பட்டியல்",
 mandi_records_subtitle: "கீழே உள்ள கார்டுகள் மற்றும் அட்டவணை அதே Data.gov.in தேடலிலிருந்து புதுப்பிக்கப்படும்.",
 mandi_table_date: "தேதி",
 mandi_table_district: "மாவட்டம்",
 mandi_table_market: "சந்தை",
 mandi_variety: "வகை",
 mandi_min_price: "குறைந்த விலை",
 mandi_modal_price: "மாடல் விலை",
 mandi_max_price: "அதிக விலை",
 mandi_table_initial: "அதிகாரப்பூர்வ பதிவுகளை ஏற்ற சந்தை விலைகளை தேடுங்கள்.",
 mandi_no_records: "பதிவுகள் இல்லை",
 mandi_try_broader: "மாவட்டம் அல்லது சந்தை வடிப்பானை விரிவாக்கவும்.",
 mandi_location_unavailable: "இடம் கிடைக்கவில்லை",
 mandi_not_specified: "குறிப்பிடப்படவில்லை",
 mandi_loading_prices: "அதிகாரப்பூர்வ சந்தை விலைகள் ஏற்றப்படுகின்றன...",
 mandi_loading: "ஏற்றப்படுகிறது...",
 mandi_no_records_long: "பதிவுகள் இல்லை. பொருள், மாவட்டம் அல்லது சந்தையை மாற்றவும்.",
 mandi_load_error: "அதிகாரப்பூர்வ சந்தை விலைகளை ஏற்ற முடியவில்லை.",
 mandi_selected_records: "அதிகாரப்பூர்வ பதிவுகள் ஏற்றப்பட்டன",
 mandi_modal_line_note: "மாடல் கோடு மிகவும் நடைமுறை வர்த்தக விலையை காட்டுகிறது."
 },
 te: {
 mandi_kicker: "అధికారిక మార్కెట్ ఇంటెలిజెన్స్",
 mandi_heading: "లైవ్ మార్కెట్ ధర ఇంటెలిజెన్స్",
 mandi_subtitle: "సురక్షిత సర్వర్-సైడ్ Data.gov.in ఇంటిగ్రేషన్‌తో రాష్ట్రాలు, జిల్లాలు, మార్కెట్లలో అధికారిక కమోడిటీ ధరలను పోల్చండి.",
 mandi_state: "రాష్ట్రం",
 mandi_commodity: "కమోడిటీ",
 mandi_district_optional: "జిల్లా ఐచ్ఛికం",
 mandi_market_optional: "మార్కెట్ ఐచ్ఛికం",
 mandi_limit: "పరిమితి",
 mandi_search_prices: "ధరలు వెతకండి",
 mandi_district_placeholder: "ఉదా. నాసిక్",
 mandi_market_placeholder: "ఉదా. లాసల్గావ్",
 mandi_chart_kicker: "మార్కెట్ ఇంటెలిజెన్స్",
 mandi_chart_title: "మార్కెట్ ధర పోలిక",
 mandi_chart_subtitle: "క్వింటాల్‌కు రూపాయిలలో అధికారిక కనిష్ట, మోడల్ మరియు గరిష్ట ధరలు",
 mandi_avg_modal: "సగటు మోడల్",
 mandi_top_market: "టాప్ మార్కెట్",
 mandi_price_spread: "ధర వ్యత్యాసం",
 mandi_chart_insight_empty: "మార్కెట్లను పోల్చడానికి ధరలు వెతకండి.",
 mandi_records_kicker: "లైవ్ రికార్డులు",
 mandi_records_title: "అధికారిక మార్కెట్ ధరల జాబితా",
 mandi_records_subtitle: "క్రింది కార్డులు మరియు పట్టిక అదే Data.gov.in శోధన నుంచి అప్డేట్ అవుతాయి.",
 mandi_table_date: "తేదీ",
 mandi_table_district: "జిల్లా",
 mandi_table_market: "మార్కెట్",
 mandi_variety: "రకం",
 mandi_min_price: "కనిష్ట ధర",
 mandi_modal_price: "మోడల్ ధర",
 mandi_max_price: "గరిష్ట ధర",
 mandi_table_initial: "అధికారిక రికార్డులు లోడ్ చేయడానికి మార్కెట్ ధరలు వెతకండి.",
 mandi_no_records: "రికార్డులు లేవు",
 mandi_try_broader: "జిల్లా లేదా మార్కెట్ ఫిల్టర్‌ను విస్తరించండి.",
 mandi_location_unavailable: "స్థానం అందుబాటులో లేదు",
 mandi_not_specified: "పేర్కొనలేదు",
 mandi_loading_prices: "అధికారిక మార్కెట్ ధరలు లోడ్ అవుతున్నాయి...",
 mandi_loading: "లోడ్ అవుతోంది...",
 mandi_no_records_long: "రికార్డులు లేవు. కమోడిటీ, జిల్లా లేదా మార్కెట్ మార్చండి.",
 mandi_load_error: "అధికారిక మార్కెట్ ధరలు లోడ్ కాలేదు.",
 mandi_selected_records: "అధికారిక రికార్డులు లోడ్ అయ్యాయి",
 mandi_modal_line_note: "మోడల్ లైన్ అత్యంత వాస్తవిక వ్యాపార ధరను చూపుతుంది."
 }
};
...
window.updateChartData = function(period, crop) {
 if (typeof window.renderLiveMandiTrend === 'function' && window.renderLiveMandiTrend(period, crop)) {
  return;
 }
